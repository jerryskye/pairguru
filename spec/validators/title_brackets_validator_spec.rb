...
describe TitleBracketsValidator do
  ...
  context "with mismatched brackets" do
    let(:title) { "The Fellowship of the (Ring}" }
    it_behaves_like "has invalid title"
  end

  context "with mismatched brackets next to themselves" do
    let(:title) { "The Fellowship of the (}" }
    it_behaves_like "has invalid title"
  end

  context "with mismatched nested brackets" do
    let(:title) { "The Fellowship of the {(Ring})" }
    it_behaves_like "has invalid title"
  end
end
